...
- `run_namespaced_job` task allowing easy execution of a well-specified job on a cluster specified by a `KubernetesCredentials` block - [#28](https://github.com/PrefectHQ/prefect-kubernetes/pull/28)
